...
public partial class YatPreferences : Resource
{
    ...
    [ExportGroup("Terminal")] [Export] public string Prompt { get; set; } = ">";
    ...
    public ushort FontSize { get; set; } = 16;
    ...
    [Ignore] [Export] public Font BaseFont { get; set; } = ThemeDB.FallbackFont;

    #endregion

    #region Colors

    [ExportGroup("Colors")] [Export] public Color InputColor { get; set; } = new("dfdfdf99"); // #dfdfdf99

    [Ignore] [Export] public Color BackgroundColor { get; set; } = new("1d2229"); // #192229
    ...
    [Export]
    public bool UseYatEnableFile { get; set; } = false;
