...
public static class Text
{
    ...
    public static string MakeBold(string text) => $"[b]{text}[/b]";

    public static string[] SanitizeText(string text) => SplitClean(text, " ");
    ...
    public static bool StartsWith(this string text, params char[] value) => value.Any(text.StartsWith);

    public static bool StartsWith(this string text, params string[] value) => value.Any(text.StartsWith);

    public static bool EndsWith(this string text, params char[] value) => value.Any(text.EndsWith);

    public static bool EndsWith(this string text, params string[] value) => value.Any(text.EndsWith);
    ...
    public static string[] SplitClean(string text, string separator) =>
        text.Split(separator, StringSplitOptions.TrimEntries |
