...
public readonly struct NodeMethodInfo
{
    ...
    public NodeMethodInfo(StringName name, Array<Dictionary<string, Variant>> args, Array<Variant> defaultArgs,
        MethodFlags flags, int id, Dictionary<string, Variant> @return)
    {
        Name = name;
        Args = args;
