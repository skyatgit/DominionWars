...
public partial class BaseTerminal : Control
{
    ...
    [Signal]
    public delegate void PositionResetRequestedEventHandler();

    [Signal]
    public delegate void SizeResetRequestedEventHandler();

    [Signal]
    public delegate void TitleChangeRequestedEventHandler(string title);
    ...
    private Yat _yat;
    public LinkedListNode<string> HistoryNode;
    ...
    public override void _Ready()
    {
        ...
        _selectedNodeLabel.Visible = Yat.IsShowPath;

        Output = GetNode<Output>("%Output");
        Output.Text = Yat.ScreenPrompt;
