...
[Option("-absolute", "bool",
    "If true, the object will be loaded at the origin, otherwise relative positioning will be used.")]
...
public sealed class Load : ICommand
{
    ...
    private static bool ValidatePath(string path) => !string.IsNullOrEmpty(path) && ResourceLoader.Exists(path);
}
